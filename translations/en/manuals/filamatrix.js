export default {
    ...
    steps: {
        ...
        filamatrix_step5: {
            title: "Heatsets",
            description: `
                <p>Install seven heatset inserts as shown. The two heatset inserts shown with yellow arrows must be installed below the surface of the printed part.</p>
                <p><strong>Note:</strong> Be sure to choose a temperature appropriate for your selected printed parts material. Be careful! Hot things are hot...</p>
            `,
            parts: [
                "motor_plate.stl",
                "7x M3 Heatset inserts"
            ]
        },
        filamatrix_step6: {
            title: "Heatsets",
            description: `
                <p>Install two heatset inserts as shown. This will be the last time your heatset tool will be used during the extruder assembly. Now is the time to turn it off and set it somewhere safe. </p>
                <p><strong>Note:</strong> Be sure to choose a temperature appropriate for your selected printed parts material. Be careful! Hot things are hot...</p>
            `,
            parts: [
                "[a]_guidler_a.stl",
        ...
        filamatrix_step14: {
            title: "Sandwich",
            description: `
                <p>Close the two halves of the extruder around the drive gear assembly as shown.</p>
            `,
            parts: []
        },
        filamatrix_step15: {
