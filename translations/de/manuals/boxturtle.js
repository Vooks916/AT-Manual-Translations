export default {
    ...
    steps: {
        ...
        boxturtle_frame_step8: {
            ...
            description: `
                <p>Entfernen Sie die Stützen wie gezeigt und entsorgen Sie sie ordnungsgemäß.</p>
            `,
            parts: [
        ...
        boxturtle_frame_step11: {
            ...
            parts: [
                "corner_printed.stl",
                "2 M5x16 BHCS",
                "2x 360mm 2020 Profile"
            ]
        },
        boxturtle_frame_step12: {
            title: "Hintere Profilbaugruppe",
            description: `
                <p>Achten Sie auf die Ausrichtung, wenn Sie die Rückwandschürzen wie abgebildet in die Profile einführen.</p>
            `,
            parts: [
                "right_rear_skirt.stl",
                "rear_skirt_center_hub.stl",
        ...
        boxturtle_frame_step16: {
            title: "Vordere Profilbaugruppe",
            description: `
                <p>Achten Sie auf die Ausrichtung, wenn Sie die Frontplattenschürzen wie gezeigt in die Profile einführen.</p>
            `,
            parts: [
                "2x front_skirt.stl"
            ]
        ...
        boxturtle_frame_step18: {
            ...
            description: `
                <p>Schrauben Sie vier M5x16 BHCS-Schrauben wie abgebildet durch die bedruckte Ecke in die 220-mm-Profile.</p>
            `,
            parts: [
                "4x 220mm 2020 Profile",
                "4x M5x16 BHCS"
            ]
        },
        ...
        boxturtle_respoolers_step8: {
            title: "MR63 Lager",
            description: `
                <p>Setzen Sie das MR63 Lager ein, und fixieren Sie es mit einer M3x10 Zylinderschraube.</p>
            ...
            `,
            parts: [
                "1x M3x10 Zylinderschraube (SHCS)",
                "1x MR63 Lager"
            ]
        },
        ...
        boxturtle_respoolers_step15: {
            ...
            description: `
                <p>Bevor Sie die LEDs installieren, stellen Sie sicher, dass die <a href="https://github.com/ArmoredTurtle/BoxTurtle/blob/main/BT_Wiring/WS2812_PCB.png" target="_blank">Kabel die richtige Länge haben</a>.</p>
                <p>Drücken Sie den Diffusor in die Lightbox. Richten Sie den Neopixel im LED-Halter aus.</p>
            `,
            parts: [
                "[a]_lightbox_x4.stl",
        ...
        boxturtle_general_assembly_step10: {
            ...
            description: `
                <p>Montieren Sie den Prep-Schalter für Lane 4 (435 mm Kabel) mit einer M3x8 Zylinderschraube und einer M3-Unterlegscheibe.</p>
        ...
        boxturtle_general_assembly_step12: {
            title: "Kabelweg",
            description: `
                <p>Hier wird die Verkabelung für Lane 4 dargestellt.</p>
                <p>Es gibt viele Kabelbinderpunkte an der Unterseite der Fächer. Die Kabel sollten aber erst am Ende gesichert werden. Sie können die Kabel für Lane 4 vorerst locker fixieren. Auf der nächsten Seite wird genau gezeigt, wo alle Kabel von Lane 4 in die AFC-Lite eingesteckt werden, um die Standard-AFC-Klipper-Konfiguration für eine schnelle Einrichtung zu verwenden.</p>
        ...
        boxturtle_general_assembly_step16: {
            title: "Hebel-Retainer Einbau",
            description: `
                <p>Montieren Sie den Prep-Schalter für Lane 3 (335 mm Kabel) mit einer M3x8 Zylinderschraube und einer M3-Unterlegscheibe.</p>
                <p>Sichern Sie ihn an der Stelle, wo der Schalter ausgelöst ist, ohne den Hebel auf dem Spooler nach vorne zu drücken. Im Normal-Zustand sollte der Prep-Sensor geschlossen sein.</p>
            `,
            parts: [
                "M3x8 Zylinderschraube (SHCS)",
        ...
        boxturtle_general_assembly_step18: {
            title: "Kabelweg",
            description: `
                <p>Hier wird die Verkabelung für Lane 3 dargestellt.</p>
                <p>Es gibt viele Kabelbinderpunkte an der Unterseite der Fächer. Die Kabel sollten aber erst am Ende gesichert werden. Sie können die Kabel für Lane 3 vorerst locker fixieren. Auf der nächsten Seite wird genau gezeigt, wo alle Kabel von Lane 3 in die AFC-Lite eingesteckt werden, um die Standard-AFC-Klipper-Konfiguration für eine schnelle Einrichtung zu verwenden.</p>
                <div class='wiring-key'>
                    <strong>LEGENDE:</strong>
                    <p class='prep'>Prep</p>
                    <p class='load'>Load</p>
        ...
        boxturtle_general_assembly_step24: {
            title: "Hebel-Retainer Einbau",
            description: `
                <p>Montieren Sie den Prep-Schalter für Lane 2 (235 mm Kabel) mit einer M3x8 Zylinderschraube und einer M3-Unterlegscheibe.</p>
                <p>Sichern Sie ihn an der Stelle, wo der Schalter ausgelöst ist, ohne den Hebel auf dem Spooler nach vorne zu drücken. Im Normal-Zustand sollte der Prep-Sensor geschlossen sein.</p>
            `,
            parts: [
                "M3x8 Zylinderschraube (SHCS)",
        ...
        boxturtle_general_assembly_step33: {
            ...
            content: `
                <div class=wiring-guide>
                    ...
                    <p>Sind Sie unsicher, welcher Stecker wofür ist? Hier ist ein <a href="/docs/afc-klipper-add-on/installation/buffer-overview.html" target="_blank">Dokument</a> das Ihnen hilft, den Buffer und seine Funktionen zu verstehen.</p>
                </div>
            `,
            parts: []
        },
        ...
        boxturtle_general_assembly_step39: {
            title: "Idler",
            description: `
                <p>Schrauben Sie die beiden Teile des Idlers auf das Gewinde. Vier davon werden benötigt.</p>
            `,
            parts: [
        ...
        boxturtle_general_assembly_step42: {
            ...
            content: `
                <div class="infoL">
                    <h3>*PANIK*</h3>                            <p>Bevor die letzten Verkleidungen an der BoxTurtle installiert werden, sollten Sie sie mit dem Drucker verbinden und die Funktionalität aller Komponenten überprüfen.</p>
                    <p class='extra-space'>Die Anleitung für die Erstinbetriebnahme, die alles enthält, was Sie wissen müssen, um Ihre BoxTurtle zum Laufen zu bringen, finden Sie <a href="/docs/boxturtle/initial_startup/01-overview.html" target="_blank">hier</a>.</p>
                    <div class='info-submanual-nav-buttons'>
                        <button onclick="location.href='manual-sections.html?manual=boxturtle'">BoxTurtle Menü</button>
